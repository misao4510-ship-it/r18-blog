#!/usr/bin/env python3
"""
cmd_236: 雪音レビュー挿絵生成 (d_194160)
novaAnimeXL_ilV170 + kurokawa_v1 LoRA
超囁き！清楚JK二条由乃と電車の中で (バイノーラル)
"""
import requests
import base64
import shutil
...
OUTPUT_DIR = Path("/home/misao/r18-blog/public/images/works/d_194160")
...
IMAGES = [
    {
        "name": "hero",
        "filename": "hero.png",
        "sd_filename": "yukine_review_d_194160_hero.png",
        "extra_positive": (
            "wearing earphones, eyes closed, gentle smile, listening to music, "
            "soft expression, blissful, lost in sound, "
            "train interior, yellow warm light, train window, evening commute, "
            "sitting in train, relaxed pose, warm ambient light, intimate atmosphere"
        ),
    },
    {
        "name": "review",
        "filename": "review.png",
        "sd_filename": "yukine_review_d_194160_review.png",
        "extra_positive": (
            "book on lap, looking out window, train window, thoughtful expression, "
            "sitting in train seat, soft natural light, gentle smile, "
            "contemplative, gazing outside, serene mood, evening light"
        ),
    },
]
