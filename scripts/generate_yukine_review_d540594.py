#!/usr/bin/env python3
"""
cmd_238: 雪音レビュー挿絵生成 (d_540594)
novaAnimeXL_ilV170 + kurokawa_v1 LoRA
作品: 推しの中の人が幼馴染 / 陽向葵ゅか1人2役
"""
import requests
import base64
import json
...
OUTPUT_DIR = Path("/home/misao/r18-blog/public/images/works/d_540594")
...
IMAGES = [
    {
        "name": "hero",
        "filename": "hero.png",
        "sd_filename": "yukine_review_d_540594_hero.png",
        "extra_positive": (
            "wearing headphones, eyes closed, gentle smile, listening to music carefully, "
            "thinking of two voices, finger on chin, thoughtful expression, "
            "living room, evening light, cozy atmosphere, sitting, relaxed pose, "
            "soft expression, peaceful, faint blush"
        ),
    },
    {
        "name": "review",
        "filename": "review.png",
        "sd_filename": "yukine_review_d_540594_review.png",
        "extra_positive": (
            "impressed expression, mouth slightly open, wide eyes, amazed, "
            "holding headphones in hands, looking up slightly, "
            "light blush, excited expression, surprised by performance, "
            "desk, notebook, pen, evening light, elegant pose"
        ),
    },
]
