#!/usr/bin/env python3
"""
cmd_235: 雪音レビュー挿絵生成 (d_220768)
novaAnimeXL_ilV170 + kurokawa_v1 LoRA
超囁き！メスガキJKリカと漫喫えっち (バイノーラル)
"""
import requests
import base64
import shutil
...
OUTPUT_DIR = Path("/home/misao/r18-blog/public/images/works/d_220768")
...
IMAGES = [
    {
        "name": "hero",
        "filename": "hero.png",
        "sd_filename": "yukine_review_d_220768_hero.png",
        "extra_positive": (
            "wearing earphones, eyes closed, gentle smile, listening to music, "
            "soft expression, peaceful, blissful, lost in sound, "
            "evening light, cozy cafe atmosphere, sitting, relaxed pose, "
            "warm ambient light, intimate setting"
        ),
    },
    {
        "name": "review",
        "filename": "review.png",
        "sd_filename": "yukine_review_d_220768_review.png",
        "extra_positive": (
            "reading book, hand on cheek, light blush, thoughtful smile, "
            "sitting at desk, soft lighting, gentle expression, "
            "contemplative, book in hand, cozy room"
        ),
    },
]
