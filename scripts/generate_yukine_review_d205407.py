...
OUTPUT_DIR = Path("/home/misao/r18-blog/public/images/works/d_205407")
...
IMAGES = [
    {
        "name": "hero",
        "filename": "hero.png",
        "sd_filename": "yukine_review_d_205407_hero.png",
        "extra_positive": (
            "holding smartphone, playing mobile game, casual clothes, soft smile, "
            "living room, evening light, cozy atmosphere, sitting on sofa, relaxed pose, "
            "happy expression, immersed in game, cheerful, warm lighting"
        ),
    },
    {
        "name": "review",
        "filename": "review.png",
        "sd_filename": "yukine_review_d_205407_review.png",
        "extra_positive": (
            "wearing headphones, light blush, soft smile, listening, "
            "eyes slightly closed, gentle expression, cozy, "
            "bedroom, warm lighting, peaceful, enjoying audio"
        ),
    },
]
