#!/usr/bin/env python3
"""
cmd_242: 雪音レビュー挿絵生成 (d_358385 パパ活JKおまこレンタル)
...
OUTPUT_DIR = Path("/home/misao/r18-blog/public/images/works/d_358385")
...
IMAGES = [
    {
        "name": "hero",
        "filename": "hero.png",
        "sd_filename": "yukine_review_d_358385_hero.png",
        "extra_positive": (
            "sitting on sofa, holding smartphone, wearing earphones, in-ear monitor, "
            "reading book on lap, neutral calm expression, slightly distant gaze, "
            "soft indoor lighting, casual atmosphere, afternoon light, "
            "white blouse, elegant casual wear, peaceful interior, bookshelf background"
        ),
    },
    {
        "name": "review",
        "filename": "review.png",
        "sd_filename": "yukine_review_d_358385_review.png",
        "extra_positive": (
            "wearing earphones, light blush on cheeks, slightly awkward expression, "
            "looking away, surprised flushed face, one hand on cheek, "
            "soft warm lighting, indoor background, simple clean background, "
            "white dress, gentle atmosphere"
        ),
    },
]
