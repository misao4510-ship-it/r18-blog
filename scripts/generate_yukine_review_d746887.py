...
OUTPUT_DIR = Path("/home/misao/r18-blog/public/images/works/d_746887")
...
IMAGES = [
    {
        "name": "hero",
        "filename": "hero.png",
        "sd_filename": "yukine_review_d_746887_hero.png",
        "extra_positive": (
            "sitting on sofa, holding book, surprised expression, slightly open mouth, "
            "eyebrows raised, reaction face, living room, evening light, cozy atmosphere, "
            "book in hands, cowboy shot"
        ),
    },
    {
        "name": "review",
        "filename": "review.png",
        "sd_filename": "yukine_review_d_746887_review.png",
        "extra_positive": (
            "hand on chin, thinking pose, contemplative, thoughtful expression, "
            "soft smile, gentle gaze, indoor, warm lighting, cowboy shot"
        ),
    },
]
