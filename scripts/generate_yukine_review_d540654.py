#!/usr/bin/env python3
"""
cmd_237: 雪音レビュー挿絵生成 (d_540654)
novaAnimeXL_ilV170 + kurokawa_v1 LoRA
作品: 巨乳ゲーマー女友達が帰ってくれない件 (KU100バイノーラル) / 陽向葵ゅか
"""
import requests
import base64
import json
...
OUTPUT_DIR = Path("/home/misao/r18-blog/public/images/works/d_540654")
...
IMAGES = [
    {
        "name": "hero",
        "filename": "hero.png",
        "sd_filename": "yukine_review_d_540654_hero.png",
        "extra_positive": (
            "holding game controller, casual outfit, light knit sweater, cozy home atmosphere, "
            "living room, sitting on sofa, gaming setup in background, "
            "warm evening light, gentle smile, relaxed pose, knees up, "
            "soft expression, comfortable atmosphere, faint blush"
        ),
    },
    {
        "name": "review",
        "filename": "review.png",
        "sd_filename": "yukine_review_d_540654_review.png",
        "extra_positive": (
            "wearing over-ear headphones, waving hand, bright smile, cheerful expression, "
            "casual home outfit, listening to audio, excited expression, "
            "desk with laptop, soft indoor light, happy pose, thumbs up"
        ),
    },
]
