...
OUTPUT_DIR = Path("/home/misao/r18-blog/public/images/works/d_325958")
...
IMAGES = [
    {
        "name": "hero",
        "filename": "hero.png",
        "sd_filename": "yukine_review_d_325958_hero.png",
        "extra_positive": (
            "wearing headphones, eyes closed, gentle smile, listening to music, "
            "living room, evening light, cozy atmosphere, sitting, relaxed pose, "
            "soft expression, peaceful, enjoying music"
        ),
    },
    {
        "name": "review",
        "filename": "review.png",
        "sd_filename": "yukine_review_d_325958_review.png",
        "extra_positive": (
            "writing in notebook, hand on cheek, light blush, thinking pose, "
            "contemplative, soft lighting, gentle smile, thoughtful expression, "
            "desk, pen in hand, studying"
        ),
    },
]
